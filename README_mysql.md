...
# name='hehe1234'是否存在，不存在则添加， 有则更新 仅适用单条语句 
ModelDemo.where('name', 'hehe1234').create_or_update({'name': "hehe1234", 'token_name': "haha124"})

# mysql on duplicate key update (根据唯一键 有则更新 无则添加, 弊端: 更新时id也会自增)
ModelDemo.insert_on_duplicate([{'name': "haha4", 'token_name': "haha'124"}, {'name': "haha3", 'token_name': "haha1124"}])
``` 
